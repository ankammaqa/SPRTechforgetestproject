...
Examples:
  ...
  Examples:
    ...
    | Expense  | 16-12-2025 |  15000 | Ajay [Bank] | Office Expense | Stationary purchase |
 ...
 Scenario Outline:Tc_03 Verify user can check on  Transactions save or Not
  ...
  Examples:
    ...
    | Stationary purchase | Expense  | Unlocked | Ajay       | Office Expense         | 16-12-2025 | 16-12-2025 |
